...
export default class News extends Component {
  ...
  async componentDidMount(){
    ...
    let url=`https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=31184537eacb40e99125a15e9d86f31b&pageSize=${this.props.pageSize}`;
  ...
  handlePreviousClick=async()=>{
      let url=`https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=31184537eacb40e99125a15e9d86f31b&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
      let data= await fetch(url);
      let parsedData= await data.json();
      this.setState({loading: true});
  ...
  render() {
    ...
    return (
      ...
      <h3 className='text-center'>Your Daily Dose of News, Just a Click Away!</h3>
        <h4 className='container my-4 text-left'>Top News</h4>
